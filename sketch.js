...
function draw(){ 
  ...
  //game state end
    ...
    //to set the velocityY of monkey to 0
    monkey.velocityY = 0;
    
    //to destroy the obstacles and bananas once the game ends
    obstacleGroup.destroyEach();
    foodGroup.destroyEach();
    
    //to change the monkey's animation 
  ...
  //to display score
   ...
   text("Obtacles Hit : "+ obstaclesHit, x1+370, 30);
